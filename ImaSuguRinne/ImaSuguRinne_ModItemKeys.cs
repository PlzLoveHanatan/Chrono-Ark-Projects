...
namespace ImaSuguRinne
{
    public static class ModItemKeys
    {
		...
		/// Echoes Rebirth
		/// </summary>
        public static string Buff_B_Rinne_EchoesRebirth = "B_Rinne_EchoesRebirth";
		/// <summary>
		/// Endless Cycle
		/// Draw 1 skill and restore 1 Mana at 2 stacks.
		/// </summary>
        public static string Buff_B_Rinne_EndlessCycle = "B_Rinne_EndlessCycle";
		/// <summary>
		/// Endless Despair
		/// Take &a damage <color=#FF7C34>(StackNum)</color> whenever a skill is drawn.
		/// </summary>
        public static string Buff_B_Rinne_EndlessDespair = "B_Rinne_EndlessDespair";
		/// <summary>
		/// Eternal Blooming
		/// At the start of each turn shuffle 3 copies of <color=#FF44AA>Eternal Requiem</color> into deck.
		/// </summary>
		...
		/// Cannot take action.
		/// </summary>
        public static string Buff_B_Rinne_ShatteredLoop = "B_Rinne_ShatteredLoop";
		/// <summary>
		/// Sorrow Embrace
		/// </summary>
        public static string Buff_B_Rinne_SorrowEmbrace = "B_Rinne_SorrowEmbrace";
		/// <summary>
		/// Sorrow Resonance
		/// </summary>
		...
		/// </summary>
        public static string SkillKeyword_KeyWord_FadingMemory = "KeyWord_FadingMemory";
		/// <summary>
		/// Rinne
		/// Passive:
		/// Hit Rate above 100% is converted into Critical Chance.
        ...
        public static string SkillEffect_SE_S_S_Rinne_CycleofEchoes_0 = "SE_S_S_Rinne_CycleofEchoes_0";
        public static string SkillEffect_SE_S_S_Rinne_CycleofEchoes_1 = "SE_S_S_Rinne_CycleofEchoes_1";
        public static string SkillEffect_SE_S_S_Rinne_CycleofSuffering_0 = "SE_S_S_Rinne_CycleofSuffering_0";
        public static string SkillEffect_SE_S_S_Rinne_CycleofSuffering_1 = "SE_S_S_Rinne_CycleofSuffering_1";
        public static string SkillEffect_SE_S_S_Rinne_DesperateSpiral = "SE_S_S_Rinne_DesperateSpiral";
        public static string SkillEffect_SE_S_S_Rinne_DualityofEchoes_0 = "SE_S_S_Rinne_DualityofEchoes_0";
        ...
        public static string SkillEffect_SE_S_S_Rinne_Rare_EternalFate_1 = "SE_S_S_Rinne_Rare_EternalFate_1";
        public static string SkillEffect_SE_S_S_Rinne_Rare_LovesRequiem = "SE_S_S_Rinne_Rare_LovesRequiem";
        ...
        public static string SkillEffect_SE_T_S_Rinne_CycleofEchoes_0 = "SE_T_S_Rinne_CycleofEchoes_0";
        public static string SkillEffect_SE_T_S_Rinne_CycleofEchoes_1 = "SE_T_S_Rinne_CycleofEchoes_1";
        public static string SkillEffect_SE_T_S_Rinne_CycleofSuffering = "SE_T_S_Rinne_CycleofSuffering";
        public static string SkillEffect_SE_T_S_Rinne_CycleofSuffering_0 = "SE_T_S_Rinne_CycleofSuffering_0";
        public static string SkillEffect_SE_T_S_Rinne_CycleofSuffering_1 = "SE_T_S_Rinne_CycleofSuffering_1";
        public static string SkillEffect_SE_T_S_Rinne_DesperateSpiral = "SE_T_S_Rinne_DesperateSpiral";
        public static string SkillEffect_SE_T_S_Rinne_DualityofEchoes_0 = "SE_T_S_Rinne_DualityofEchoes_0";
        public static string SkillEffect_SE_T_S_Rinne_DualityofEchoes_1 = "SE_T_S_Rinne_DualityofEchoes_1";
        public static string SkillEffect_SE_T_S_Rinne_EmbraceofSorrow = "SE_T_S_Rinne_EmbraceofSorrow";
		...
		/// <summary>
		/// Cascade of Pain
		/// Deal &a additional damage for each debuff on the target.
		/// This skill can be played repeatedly during this turn.
		/// </summary>
		...
		/// </summary>
        public static string Skill_S_Rinne_Draw = "S_Rinne_Draw";
		/// <summary>
		/// Endless Sorrow
		/// If facing one enemy, apply additional skills debuffs to the target.
		/// This skill can be played repeatedly during this turn.
		/// </summary>
