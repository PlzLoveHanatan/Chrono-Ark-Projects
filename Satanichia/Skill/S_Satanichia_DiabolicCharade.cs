...
namespace Satanichia
{
    ...
    /// Discard up to 4 skills, for each skill discarded increase this skill's damage by &a. Draw 2 additional skills next turn.
    /// Sheathe : Draw this skill again.
    /// </summary>
    public class S_Satanichia_DiabolicCharade : SkillExtedned_IlyaP
    {
        ...
        public override void SkillUseSingle(Skill SkillD, List<BattleChar> Targets)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                BattleSystem.instance.AllyTeam.LucyAlly.BuffAdd(ModItemKeys.Buff_B_Satanichia_DrawNextTurn, BChar, false, 0, false, -1, false);
            }
        }
