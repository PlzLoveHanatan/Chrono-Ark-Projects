...
namespace EmotionSystem
{
	public class Debuffs
	{
		public class Bleed : Buff, IP_BuffObject_Updata, IP_TurnEnd
		{
			...
			{
				string text = ModLocalization.EmotionSystem_Bleed_1;
				if (BChar is BattleEnemy)
				{
					text = ModLocalization.EmotionSystem_Bleed_0;
				}
		...
		public class Burn : Buff, IP_TurnEnd, IP_BuffObject_Updata
		{
			...
			public override string DescExtended()
			{
				string text = ModLocalization.EmotionSystem_Burn_1;
				if (BChar is BattleEnemy)
				{
					text = ModLocalization.EmotionSystem_Burn_0;
				}
