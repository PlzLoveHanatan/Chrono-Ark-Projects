...
namespace QoH
{
	public class QoH_Chibi_QueenOfHatred : MonoBehaviour
	{
		...
		public int spinBlastTurns = 2;
		public float spinBlastDuration = 2f;

		public float bounceRampageHeight = 80f;
		public int bounceRampageCount = 4;
		public float bounceRampageDuration = 2f;

		public float lightningSlideDistance = 200f;
		public float lightningSlideJump = 50f;
		public float lightningSlideDuration = 1.2f;
		...
		public float flutterSpinRotation = 45f;
		...
		private void LightningSlide()
		{
			...
			float y = Mathf.Sin(t * Mathf.PI) * lightningSlideJump;
			transform.localPosition = Vector3.Lerp(startPos + new Vector3(-lightningSlideDistance, 0, 0), startPos, t) + new Vector3(0, y, 0);
