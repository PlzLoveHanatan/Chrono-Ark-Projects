...
namespace Xao
{
    public static class ModItemKeys
    {
		...
		/// </summary>
        public static string Buff_B_Xao_MagicalClimax = "B_Xao_MagicalClimax";
		/// <summary>
		/// Magical Desire
		/// Whenever playing skill increase <color=#87CEFA>Combo</color> by <color=#d78fe9>1</color> and remove 1 stack.
		/// </summary>
        public static string Buff_B_Xao_MagicalDesire = "B_Xao_MagicalDesire";
		/// <summary>
		/// Magical Ecstasy
		/// </summary>
        public static string Buff_B_Xao_MagicalEcstasy = "B_Xao_MagicalEcstasy";
		/// <summary>
		/// Magical Tease
		/// </summary>
        public static string Buff_B_Xao_MagicalTease = "B_Xao_MagicalTease";
		/// <summary>
		/// Mistress' Dominance
		...
		/// <summary>
		/// Mistress' Supremacy
		/// Apply an additional stack of the same buff or debuff to the target.
		/// </summary>
        public static string Buff_B_Xao_MistressSupremacy = "B_Xao_MistressSupremacy";
		/// <summary>
		/// Mistress' Touch
		/// </summary>
		...
		/// Wet Lust
		/// </summary>
        public static string Buff_B_Xao_WetLust = "B_Xao_WetLust";
		/// <summary>
		/// Love Egg
		...
		/// <summary>
		/// <color=#4169E1>Wet Dream</color>
		/// <color=#919191>Cannot gain Overload.</color>
		/// </summary>
        public static string SkillKeyword_KeyWord_WetDream = "KeyWord_WetDream";
        ...
        public static string SkillEffect_SE_T_S_Xao_B_WetBliss = "SE_T_S_Xao_B_WetBliss";
		...
		/// </summary>
        public static string Skill_S_Xao_B_WetBliss = "S_Xao_B_WetBliss";
		/// <summary>
		/// Cowgirl ♡
		...
		/// <summary>
		/// Cowgirl ♡♡♡
		/// <color=#87CEFA>Combo</color> <color=#d78fe9>5</color>: Always apply <color=#FF1493>Pleasure Lock</color> to the target.
		/// </summary>
		...
		/// Cowgirl Pleasure ♥♥♥
		/// <color=#87CEFA>Combo</color> <color=#d78fe9>5</color>: Always apply <color=#FF1493>Pleasure Lock</color> to the target.
		/// <color=#87CEFA>Combo</color> <color=#d78fe9>7</color>: Destroy the target's Action Point.
		/// </summary>
		...
		/// <summary>
		/// Experience Maid Footjob ♡♡♡
		/// <color=#87CEFA>Combo</color> <color=#d78fe9>3</color>: Attack all enemies with the same Taunt status as the target.
		/// </summary>
		...
		/// Experience Maid Footjob Pleasure ♥♥♥
		/// <color=#87CEFA>Combo</color> <color=#d78fe9>3</color>: Attack all enemies with the same Taunt status as the target.
		/// <color=#87CEFA>Combo</color> <color=#d78fe9>5</color>: Apply 2 additional stacks of 'Mistress' Touch' to the target's.
		/// </summary>
		...
		/// <summary>
		/// Magical Girl Pussy ♡♡♡♡
		/// <color=#87CEFA>Combo</color> <color=#d78fe9>4</color>: Cost is reduced by 1.
		...
		/// <color=#87CEFA>Combo</color> <color=#d78fe9>4</color>: Cost is reduced by 1.
		/// <color=#87CEFA>Combo</color> <color=#d78fe9>6</color>: All allies gain 1 <sprite name="Xao_Heart">.
		/// <color=#87CEFA>Combo</color> <color=#d78fe9>8</color>: Apply 2 stack of  <color=#00FA9A>Magical Ecstasy</color> to all allies.
		/// </summary>
		...
		/// <summary>
		/// Swimsuit Day ♡♡♡
		/// <color=#87CEFA>Combo</color> <color=#d78fe9>4</color>: Increase all target's debuff stacks by 1.
		/// </summary>
		...
		/// Swimsuit Day Pleasure ♥♥♥
		/// <color=#87CEFA>Combo</color> <color=#d78fe9>4</color>: Increase all target's debuff stacks by 1.
		/// <color=#87CEFA>Combo</color> <color=#d78fe9>6</color>: All target's debuffs remain an extra turn.
		/// </summary>
