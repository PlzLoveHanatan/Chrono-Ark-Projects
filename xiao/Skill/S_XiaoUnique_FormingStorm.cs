...
namespace Xiao
{
    ...
    /// </summary>
    public class S_XiaoUnique_FormingStorm : Ex_EmotionalSystem_EGO
    {
        ...
        {
            this.BChar.BuffAdd(ModItemKeys.Buff_B_XiaoUnique_ForminStorm, this.BChar, false, 0, false, -1, false);
