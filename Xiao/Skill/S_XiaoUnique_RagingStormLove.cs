...
namespace Xiao
{
    ...
    /// </summary>
    public class S_XiaoUnique_RagingStormLove : Skill_Extended
    {
        ...
        public IEnumerator Damage(List<BattleChar> Targets)
        {
            ...
            Skill skill2 = Skill.TempSkill(ModItemKeys.Skill_S_XiaoUnique_RagingStormLove, this.BChar, this.BChar.MyTeam);
            skill2.PlusHit = true;
            skill2.FreeUse = true;
