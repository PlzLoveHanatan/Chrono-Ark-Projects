...
namespace Raphi
{
    ...
    public class B_CelestialConnection : Buff
    {
        ...
        public void Call()
        {
            ...
            if (Accelerate)
            {
                if (BattleSystem.instance.AllyTeam.Skills.Count == 0 && base.StackNum >= 1)
                {
        ...
        private IEnumerator Del()
        {
            ...
            BattleSystem.DelayInput(BattleSystem.I_OtherSkillSelect(choiceList, SkillButton, ModLocalization.Discard, true));
        }
