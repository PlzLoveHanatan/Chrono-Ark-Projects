...
namespace EmotionalSystem
{
    ...
    {
        private static readonly Dictionary<string, List<string>> BossActions = new Dictionary<string, List<string>>()
        {
        ...
        public void EnemyNewTurn()
        {
            if (BChar is BattleEnemy enemy)
            {
                ...
                { // predefined action for undefined bosses (likely mod bosses)
                    skill = Skill.TempSkill(ModItemKeys.Skill_S_EmotionalSystem_EmotionBurst, BChar, BChar.MyTeam);
                }
                else
