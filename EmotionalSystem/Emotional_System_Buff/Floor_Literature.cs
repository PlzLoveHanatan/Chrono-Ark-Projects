		...
		public class Abnormality
		{
			public class Lv1
			{
				public class LookDay : Buff, IP_Awake, IP_SomeOneDead
				{
					...
					public Dictionary<VisualUi.SpriteTypeFace, Sprite> FaceSprites = new Dictionary<VisualUi.SpriteTypeFace, Sprite>();
					...
					public override void FixedUpdate()
					{
						...
						VisualUi.SpriteTypeFace faceType;
						string faceName;

						// Соответствие значений лицам
						switch (currentPercent)
						{
							case -40: faceType = VisualUi.SpriteTypeFace.Face_VeryHappy; faceName = "Face_VeryHappy"; break;
							case -20: faceType = VisualUi.SpriteTypeFace.Face_Happy; faceName = "Face_Happy"; break;
							case 0: faceType = VisualUi.SpriteTypeFace.Face_Normal; faceName = "Face_Normal"; break;
							case 20: faceType = VisualUi.SpriteTypeFace.Face_Angry; faceName = "Face_Angry"; break;
							case 40: faceType = VisualUi.SpriteTypeFace.Face_VeryAngry; faceName = "Face_VeryAngry"; break;
							default: faceType = VisualUi.SpriteTypeFace.Face_Normal; faceName = "Face_Normal"; break;
						}
				...
				public class Cocoon : Buff, IP_SkillUse_Target, IP_PlayerTurn
				{
					...
					public void AttackEffect(BattleChar hit, SkillParticle SP, int DMG, bool Cri)
					{
						if (SP.SkillData.Master == BChar && !oncePerTurn)
						{
							...
							Utils.AddDebuff(hit, BChar, ModItemKeys.Buff_B_EmotionalSystem_Fragile);
							Utils.AddDebuff(hit, BChar, ModItemKeys.Buff_B_EmotionalSystem_Bind);
							oncePerTurn = true;
						}
					}
				}
