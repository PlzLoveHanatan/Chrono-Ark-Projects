...
namespace Mia
{
    ...
    /// Savage Impulse
    /// </summary>
    public class B_Mia_SavageImpulse : Buff
    {
        public override void BuffOneAwake()
        {
            base.BuffOneAwake();
            BuffIcon.AddComponent<Button>().onClick.AddListener(MiaCall);
        }
        public void MiaCall()
        {
        ...
        private IEnumerator Del()
        {
            ...
            BattleSystem.DelayInput(BattleSystem.I_OtherSkillSelect(choiceList, SkillButton, ModLocalization.Discard, false));
        }
